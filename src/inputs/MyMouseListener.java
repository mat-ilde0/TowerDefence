	...
	public void mouseDragged(MouseEvent e) {
		switch (GameStates.gameState) {
			...
			case SETTINGS:
				...
				break;
			case EDIT:
				game.geteEditor().mouseDragged(e.getX(), e.getY());
				break;
			default:
				break;
		}	
	...
	public void mouseMoved(MouseEvent e) {
		switch (GameStates.gameState) {
			...
			case SETTINGS:
				...
				break;
			case EDIT:
				game.geteEditor().mouseMoved(e.getX(), e.getY());
				break;
			default:
				break;
		}	
		...
		if(e.getButton() == MouseEvent.BUTTON1) {
			...
			switch (GameStates.gameState) {
				...
				case SETTINGS:
					...
					break;
				case EDIT:
					game.geteEditor().mouseClicked(e.getX(), e.getY());
					break;
				default:
					break;
			}			
				...
				switch (GameStates.gameState) {
					...
					case SETTINGS:
						game.getSettings().mousePressed(e.getX(), e.getY());
							break;
					case EDIT:
						game.geteEditor().mousePressed(e.getX(), e.getY());
						break;
					default:
						break;
				}			
		...
		if(e.getButton() == MouseEvent.BUTTON1) {
			...
			switch (GameStates.gameState) {
				...
				case SETTINGS:
					...
					break;
				case EDIT:
					game.geteEditor().mouseReleased(e.getX(), e.getY());
					break;
				default:
					break;
			}			
